...
describe BazaModels::Model::Validations do
  ...
  it "#before_validation, #after_validation" do
    expect(user.before_validation_called).to be_nil
    expect(user.after_validation_called).to be_nil
    user.valid?
  ...
  it "#before_validation_on_create, #after_validation_on_create, #before_validation_on_update, #after_validation_on_update" do
    expect(user.before_validation_on_create_called).to be_nil
    expect(user.after_validation_on_create_called).to be_nil

    expect(user.before_validation_on_update_called).to be_nil
    expect(user.after_validation_on_update_called).to be_nil
